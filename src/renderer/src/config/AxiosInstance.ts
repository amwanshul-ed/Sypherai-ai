...
AxiosInstance.interceptors.response.use(
  ...
  async (error: AxiosError) => {
    ...
    if (
      ...
      try {
        const currentRefreshToken = localStorage.getItem('sypher_cloud_token')
        ...
        if (res.data.refreshToken) {
          localStorage.setItem('sypher_cloud_token', res.data.refreshToken)
        }
        ...
        localStorage.removeItem('sypher_cloud_token')
